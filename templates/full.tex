...
\newsavebox\IBoxA \newsavebox\IBoxB \newlength\IHeight
\newcommand\TwoSubFig[8][H]{% CaptionLabel Image1 Caption1Label1 Width1 Image2 ...
  \sbox\IBoxA{\includegraphics[width=#5\textwidth]{#3}}
  \sbox\IBoxB{\includegraphics[width=#8\textwidth]{#6}}%
  ...
  \includegraphics[height=\IHeight]{#6}
  #7
  \end{subfigure}
  #2
  \end{figure}%
